...
namespace Polynds\ThinkphpSentry\Tracing;
...
use Polynds\ThinkphpSentry\BaseServiceProvider;
use Polynds\ThinkphpSentry\Tracing\Routing\TracingCallableDispatcherTracing;
use Polynds\ThinkphpSentry\Tracing\Routing\TracingControllerDispatcherTracing;

class ServiceProvider extends BaseServiceProvider
{
    public const DEFAULT_INTEGRATIONS = [
        \Polynds\ThinkphpSentry\Tracing\Integrations\LighthouseIntegration::class,
    ];
