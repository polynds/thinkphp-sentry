...
use Polynds\ThinkphpSentry\Console\AboutCommandIntegration;
use Polynds\ThinkphpSentry\Console\PublishCommand;
use Polynds\ThinkphpSentry\Console\TestCommand;
use Polynds\ThinkphpSentry\Features\Feature;
use Polynds\ThinkphpSentry\Http\FlushEventsMiddleware;
use Polynds\ThinkphpSentry\Http\LaravelRequestFetcher;
use Polynds\ThinkphpSentry\Http\SetRequestIpMiddleware;
use Polynds\ThinkphpSentry\Http\SetRequestMiddleware;
use Polynds\ThinkphpSentry\Tracing\BacktraceHelper;
use Polynds\ThinkphpSentry\Tracing\ServiceProvider as TracingServiceProvider;
...
use Throwable;
use function Sentry\Laravel\storage_path;
...
class ServiceProvider extends BaseServiceProvider
{
    ...
    protected const FEATURES = [
        \Polynds\ThinkphpSentry\Features\LogIntegration::class,
        \Polynds\ThinkphpSentry\Features\CacheIntegration::class,
        \Polynds\ThinkphpSentry\Features\QueueIntegration::class,
        \Polynds\ThinkphpSentry\Features\ConsoleIntegration::class,
        \Polynds\ThinkphpSentry\Features\Storage\Integration::class,
        \Polynds\ThinkphpSentry\Features\HttpClientIntegration::class,
        \Polynds\ThinkphpSentry\Features\FolioPackageIntegration::class,
        \Polynds\ThinkphpSentry\Features\NotificationsIntegration::class,
        \Polynds\ThinkphpSentry\Features\LivewirePackageIntegration::class,
        \Polynds\ThinkphpSentry\Features\ConsoleSchedulingIntegration::class,
    ];
        ...
        $this->app->singleton(HubInterface::class, function () {
            ...
            $options->setIntegrations(static function (array $integrations) use ($options, $userIntegrations, $userIntegrationOption): array {
                ...
                $integrations = array_merge(
                    ...
                    [
                        new Integration,
                        new \Polynds\ThinkphpSentry\Integration\LaravelContextIntegration,
                        new \Polynds\ThinkphpSentry\Integration\ExceptionContextIntegration,
                    ],
                    $userIntegrations
                );
