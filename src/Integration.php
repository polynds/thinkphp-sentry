...
class Integration implements IntegrationInterface
{
    ...
    {
        return new \Polynds\ThinkphpSentry\Integration\ModelViolations\MissingAttributeModelViolationReporter($callback, $suppressDuplicateReports, $reportAfterResponse);
    }
    ...
    {
        return new \Polynds\ThinkphpSentry\Integration\ModelViolations\LazyLoadingModelViolationReporter($callback, $suppressDuplicateReports, $reportAfterResponse);
    }
    ...
    {
        return new \Polynds\ThinkphpSentry\Integration\ModelViolations\DiscardedAttributeViolationReporter($callback, $suppressDuplicateReports, $reportAfterResponse);
    }
